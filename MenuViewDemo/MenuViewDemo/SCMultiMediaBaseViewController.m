//
//  SCMultiMediaBaseViewController.m
//  TdxController
//
...
#import "SCMultiMediaBaseViewController.h"
#import "UIView+Extension.h"
#import "ZTPage.h"
#import "TestViewController.h"

@interface SCMultiMediaBaseViewController ()<UIScrollViewDelegate,MenuViewDelegate,NSCacheDelegate>
...
@implementation SCMultiMediaBaseViewController
...
- (void)loadMenuViewWithTitles:(NSArray *)titles
{
    ...
    MenuView *Menview = [[MenuView alloc]initWithMneuViewStyle:self.style AndTitles:titles hasMiddleLine:NO];
    Menview.bAutoLayout = YES;
...
- (void)viewWillLayoutSubviews
{
    ...
    self.moreButton.frame = CGRectMake(UIScreenWidth-MoreButtonWidth, 0, MoreButtonWidth, MenuHeight);
